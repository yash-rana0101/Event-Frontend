      ...
      <div className="relative w-full max-w-lg mx-auto">
        ...
        <div className="relative bg-black border border-cyan-500/30 rounded-2xl shadow-2xl p-8 overflow-hidden">
          ...
          <div className="relative">
            ...
            <button
              onClick={() => navigate(-1)}
              className="group relative flex items-center bg-black text-cyan-400 border border-cyan-500/50 rounded-lg px-6 py-3 overflow-hidden transition-all duration-300 hover:bg-cyan-500 hover:text-black focus:outline-none cursor-pointer"
            >
