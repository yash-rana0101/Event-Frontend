                      ...
                      <AnimatePresence mode="wait">
                        {!isSubmitted ? (
                          ...
                          <motion.div
                            ...
                            className="absolute right-1 top-1 bottom-1 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full px-6 font-medium flex items-center justify-center"
                          >
                            <motion.span
                              initial={{ scale: 0 }}
                              animate={{ scale: 1 }}
